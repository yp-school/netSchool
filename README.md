...
![https://img.shields.io/badge/-1.4.0-orange.svg?longCache=true&style=flat-square](https://img.shields.io/badge/-1.4.0-orange.svg?longCache=true&style=flat-square)
...
FEBS-是一款简单高效的后台权限管理系统，使用Spring Boot，和Layui构建。FEBS意指：**F**ast，**E**asy use，**B**eautiful和**S**afe。相信无论作为企业级应用，私活开发脚手架或者权限系统构建学习，FEBS-都会是一个不错的选择。

### 演示地址

[http://.febs.我爱你:8080](http://.febs.我爱你:8080)  or  [http://49.234.20.223:8080/login](http://49.234.20.223:8080/login)
...
名称 | 描述| 地址
---|---|---
FEBS- 1.x | Spring Boot 2.0.4 & 1.4.0 权限管理系统（单页）。 | [https://github.com/wuyouzhuguli/FEBS-/tree/mysql](https://github.com/wuyouzhuguli/FEBS-/tree/mysql)
